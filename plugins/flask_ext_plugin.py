...
the AST, PyLintASTWalker will call visit_foo."""
    ...
    """
        ...
        for (name, as_name) in stmt.names:
            self.locals.append((as_name or name, new_stmt))
    ...
    def visit_module(self, module):
        """Visit module"""
        for (name, stmt) in self.locals:
            if module == stmt.parent:
                module.set_local(name, stmt)
